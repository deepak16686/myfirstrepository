...
meta = '{"profile_image_url": "/static/favicon.png", "description": "Generate GitLab CI/CD pipelines using private Nexus registry images", "capabilities": {"file_context": true, "vision": true, "file_upload": true, "web_search": false, "image_generation": false, "code_interpreter": true, "citations": true, "status_updates": true, "builtin_tools": true}, "suggestion_prompts": null, "tags": [], "toolIds": ["nexus_docker_images", "gitlab_pipeline_generator"], "defaultFeatureIds": ["code_interpreter"]}'
