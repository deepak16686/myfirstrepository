...
class GitHubPipelineGeneratorService:
    ...
    async def generate_workflow_files(
        ...
        print(f"[GitHub Pipeline] Analyzing {repo_url}: {language}/{framework} version={requested_version or 'default'}")
    ...
    def _build_generation_prompt(
        ...
        prompt = f"""Generate a Gitea Actions workflow and Dockerfile for a {analysis['language']} project.
