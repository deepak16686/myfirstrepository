...
vault kv put secret/gitea token="${GITEA_TOKEN}" username="${GITEA_ADMIN_USER:-admin}" password="${GITEA_ADMIN_PASSWORD:-admin123}"
vault kv put secret/sonarqube password='${SONARQUBE_ADMIN_PASSWORD}' token=""
vault kv put secret/nexus username="admin" password="r"
vault kv put secret/jenkins username="admin" password="admin123" git_token="${GITEA_TOKEN}"
vault kv put secret/splunk token=""
vault kv put secret/jira username="" api_token=""
vault kv put secret/terraform git_token="${GITEA_TOKEN}"
