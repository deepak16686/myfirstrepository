...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-[11px] uppercase tracking-wider text-muted-foreground font-semibold',
      inset && 'pl-8',
      className
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  <span
    className={cn('ml-auto text-xs tracking-widest font-mono text-muted-foreground', className)}
    {...props}
  />
);
